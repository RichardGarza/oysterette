      ...
      recommendations = await retryWithBackoff(async () => {
        ...
        if (!preferences) {
          ...
          return topRated.map((oyster: any) => ({
            ...
            standoutNotes: oyster.standoutNotes,
            size: oyster.size,
            body: oyster.body,
            sweetBrininess: oyster.sweetBrininess,
            flavorfulness: oyster.flavorfulness,
            creaminess: oyster.creaminess,
            avgSize: oyster.avgSize,
            avgBody: oyster.avgBody,
            avgSweetBrininess: oyster.avgSweetBrininess,
            avgFlavorfulness: oyster.avgFlavorfulness,
            avgCreaminess: oyster.avgCreaminess,
            overallScore: oyster.overallScore,
            totalReviews: oyster.totalReviews,
            createdAt: oyster.createdAt,
            updatedAt: oyster.updatedAt,
            similarity: null,
            reason: 'top_rated',
          }));
        }
