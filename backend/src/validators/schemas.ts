...
export const createReviewSchema = z.object({
  ...
  size: z.number().int().min(1).max(10, 'Size must be between 1 and 10').optional(),
  body: z.number().int().min(1).max(10, 'Body must be between 1 and 10').optional(),
  sweetBrininess: z.number().int().min(1).max(10, 'Sweet/Brininess must be between 1 and 10').optional(),
  flavorfulness: z.number().int().min(1).max(10, 'Flavorfulness must be between 1 and 10').optional(),
  creaminess: z.number().int().min(1).max(10, 'Creaminess must be between 1 and 10').optional(),
