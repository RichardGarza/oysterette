    ...
    try {
      ...
      if (reviewCount > 0) {
        try {
          ...
          console.error('❌ [RegisterScreen] Failed to submit pending reviews:', error);
        }
      }

      const successMessage = reviewCount > 0
        ? `Account created! Your ${reviewCount === 1 ? 'review has' : `${reviewCount} reviews have`} been saved.`
